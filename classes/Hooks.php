...
echo ' test_0 ';
		...
		if (!in_array($target->getNamespace(), [NS_USER, NS_USER_TALK, NS_USER_PROFILE]) || $target->isSubpage()) {
echo ' test_0 short circuited for '.$target->getNamespace().':'.$target->getText().' ';
			return true;
		}
