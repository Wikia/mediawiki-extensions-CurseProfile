  function CurseProfile($) {
	...
	this.init = function () {
		...
		// Prevent links generated by wikitext from opening a new window
		$('.user-profile-navigation__link a').each(function () {
			...
			saveField: function (e, fields, blockId) {
				...
				if (fields.length == 1) {
					...
					*/
					...
					console.log('curseprofile.js - data fields include: ', data);
