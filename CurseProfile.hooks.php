...
class Hooks {
	...
	public static function onBeforeCreateEchoEvent( &$notifications, &$notificationCategories /* , &$icons */ ) {
		...
		$notifications['friendship-request'] = [
			...
			'group' => 'interactive',
			'icon' => 'gratitude',
			'presentation-model' => 'CurseProfile\Echo\FriendshipPresentationModel',
			'formatter-class' => 'CurseProfile\Echo\NotificationFormatter',
		...
		$notifications['profile-comment'] = [
			...
			'group' => 'interactive',
			'icon' => 'chat',
			'presentation-model' => 'CurseProfile\Echo\CommentPresentationModel',
			'formatter-class' => 'CurseProfile\Echo\NotificationFormatter',
